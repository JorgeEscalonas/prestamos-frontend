          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-xl mx-auto">
            <div>
              <div class="mb-5 sm:mb-8">
                <h1
                  class="mb-2 font-bold text-gray-800 text-4xl dark:text-white/90 sm:text-title-md"
                >
                  Iniciar Sesión
                </h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  Ingresa tu cédula y contraseña para acceder
                </p>
              </div>
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        class="h-11 w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:bg-gray-900 dark:border-gray-700 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-blue-400"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div class="relative">
                        <input
                          ...
                          class="h-11 w-full rounded-lg border border-gray-300 bg-white py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:bg-gray-900 dark:border-gray-700 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-blue-400"
                        />

                        <span
                          @click="togglePasswordVisibility"
                          class="absolute z-30 text-gray-600 -translate-y-1/2 cursor-pointer right-4 top-1/2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300"
                        >
                          <svg
                            v-if="!showPassword"
                            class="fill-current"
                            ...
                            <div
                              :class="
                                keepLoggedIn
                                  ...
                                  : 'bg-white border-gray-300 dark:bg-transparent dark:border-gray-700'
                              "
                    ...
                    <div>
                      <button
                        type="submit"
                        class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-blue-600 shadow-theme-xs hover:bg-blue-700"
                      >
                        Iniciar Sesión
                      </button>
                    </div>
        ...
        >
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-white dark:text-white/60">
