          ...
          <div v-if="selectedPago" class="space-y-6">
            ...
            <div v-if="loanPaymentHistory.length > 0" class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600">
              ...
              <div class="space-y-2">
                ...
                >
                  <div class="shrink-0 w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-xs font-bold">
                    {{ index + 1 }}
                  </div>
                  <div class="flex-1">
              ...
              <div class="mt-4 pt-4 border-t border-gray-300 dark:border-gray-600">
                ...
                <div class="w-full bg-gray-200 rounded-full h-3 dark:bg-gray-600">
                  <div 
                    class="bg-linear-to-r from-blue-500 to-green-500 h-3 rounded-full transition-all duration-300" 
